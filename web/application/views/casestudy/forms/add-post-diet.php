           ...
           <!-- Form - 01 -->
                ...
                <!-- Form - 02 -->
                    ...
                    <div class="dropdown2" style="display: none;" id="dropdown2">
                      ...
                      <div class="row1">
                        <label for="event-title" class="form-label">Event Title : </label>
                        <input type="text" class="form-control" id="event-title" name="itemheading2" placeholder="Diet Event - 2">
                        </div>
                  ...
                  <!-- Form - 03 -->
                    ...
                    <div class="dropdown3" style="display: none;" id="dropdown3">
                      ...
                      <div class="row1">
                        <label for="event-title" class="form-label">Event Title : </label>
                        <input type="text" class="form-control" id="event-title" name="itemheading3" placeholder="Diet Event - 3">
                        </div>
                    ...
                    <!-- Form - 04 -->
                      ...
                      <div class="row1">
                        <label for="event-title" class="form-label">Event Title : </label>
                        <input type="text" class="form-control" id="event-title" name="itemheading4" placeholder="Diet Event - 4">
                        </div>
                  ...
                  <!-- Form - 05 -->
                      ...
                      <div class="row1">
                        <label for="event-title" class="form-label">Event Title : </label>
                        <input type="text" class="form-control" id="event-title" name="itemheading5" placeholder="Diet Event - 5">
                        </div>
                    ...
                    <!-- Form - 06 -->
                      ...
                      <div class="row1">
                        <label for="event-title" class="form-label">Event Title : </label>
                        <input type="text" class="form-control" id="event-title" name="itemheading6" placeholder="Diet Event - 6">
                        </div>

                        <div class="row1">
                        <label for="event-desc" class="form-label">Event Description : </label>
                        <textarea id="event-desc" class="form-control" name="itemdesc6" placeholder="add a description about the diet event" style="height:100px"></textarea>
                        </div>

                        <div class="row1">
                        <label for="time" class="form-label">Amount : </label>
                        <input type="text" class="form-control" id="time" name="time6" placeholder="Enter in grams">
                        </div>
                    ...
                    <!-- Form - 07 -->
                      ...
                      <div class="row1">
                        <label for="event-title" class="form-label">Event Title : </label>
                        <input type="text" class="form-control" id="event-title" name="itemheading7" placeholder="Diet Event - 7">
                        </div>

                        <div class="row1">
                        <label for="event-desc" class="form-label">Event Description : </label>
                        <textarea id="event-desc" class="form-control" name="itemdesc7" placeholder="add a description about the diet event" style="height:100px"></textarea>
                        </div>

                        <div class="row1">
                        <label for="time" class="form-label">Amount : </label>
                        <input type="text" class="form-control" id="time" name="time7" placeholder="Enter in grams">
                        </div>
