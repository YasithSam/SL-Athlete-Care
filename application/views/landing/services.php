    ...
    <div class="cards_wrap">
        <div class="card_item">
            <div class="card_inner">
                ...
                <div class="title_name">Search Doctor</div>
        ...
        <div class="card_item">
            <div class="card_inner">
                <img src="../../public/assets/img/2643830.png" alt="icon">
                <div class="title_name">24/7 Service</div>
                <div class="content_part">Choose your doctor from the best in the field</div>
            </div>
        </div>
        ...
        <div class="card_item">
            <div class="card_inner">
                <img src="../../public/assets/img/1934415.png" alt="icon">
                <div class="title_name">Paramedical Services</div>
                <div class="content_part">Choose your doctor from the best in the field</div>
            </div>
        </div>
